            ...
            <td style="color: #ffffff;" class="header-text">
                ...
                <div><!--[if mso]>
                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:40px;v-text-anchor:middle;width:150px;" stroke="f" fillcolor="#2b934f">
                        ...
                        <center>
                    <![endif]-->
                    <a href="{{ URL::to('/') }}/reset/{{ $user->email }}/{{ $code }}"
                       style="background-color:#2b934f;color:#ffffff;display:inline-block;font-family:Helvetcia, sans-serif;font-size:16px;font-weight:light;line-height:40px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Reset Your Password</a>
                    <!--[if mso]>
                    </center>
                    </v:rect>
                    <![endif]-->
