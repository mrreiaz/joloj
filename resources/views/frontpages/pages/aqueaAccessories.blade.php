		...
		<div class="breadcrumbs">
			<div class="container">
				<ol class="breadcrumb breadcrumb--ys pull-left">
					...
					<li class="active">Accessorie's</li>
				</ol>
			</div>
		</div>
		<!-- /breadcrumbs --> 
			...
			<div class="container">
				...
				<div class="row">
					...
					<aside class="col-md-12 col-lg-12 col-xl-12" id="centerColumn">
						<!-- title -->
						<div class="title-box">
							<h2 class="text-center text-uppercase title-under">Aquarium Accessorie's</h2>
						</div>
						<!-- /title -->												
								...
								<div class="product product--zoom">
									<div class="product__inside">
										...
										<div class="product__inside__image">
											<a href=""> <img src="public/{{ $accessorie->product_photo }}" alt="{{ $accessorie->name }}"> </a> 
											<!-- quick-view --> 
										...
										<div class="product__inside__name">
											<h2><a href="">{{ $accessorie->name }}</a></h2>
										</div>
										<!-- /product name -->                 <!-- product description --> 
										<!-- visible only in row-view mode -->
										<div class="product__inside__description row-mode-visible">{!! $accessorie->short_description !!} </div>
										<!-- /product description -->                 <!-- product price -->
										<div class="product__inside__price price-box">৳ {{ $accessorie->real_price }}</div>
										<!-- /product price --> 
										<!-- product review --> 
										<!-- visible only in row-view mode -->
										...
										<div class="product__inside__hover">
											...
											<div class="product__inside__info">
												<div class="product__inside__info__btns"> <a href="{{ action('CartController@addItem',$accessorie->id) }}" class="btn btn--ys btn--xl"><span class="icon icon-shopping_basket"></span> Add to cart</a>
