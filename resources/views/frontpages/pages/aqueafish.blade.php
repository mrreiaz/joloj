			...
			<div class="container">
				...
				<div class="row">
					...
					<aside class="col-md-12 col-lg-12 col-xl-12" id="centerColumn">
						<!-- title -->
						<div class="title-box">
							<h2 class="text-center text-uppercase title-under">Aquarium Fish's</h2>
						</div>
						<!-- /title -->												
								...
								<div class="product product--zoom">
									<div class="product__inside">
										...
										<div class="product__inside__image">
											<a href="{{ action('FrontPageController@getProduct',$fishe->id) }}" " > <img src="public/{{ $fishe->product_photo }}" alt="{{ $fishe->name }}"> </a> 
											<!-- quick-view --> 
											<!--<a href="#" data-toggle="modal" data-target="#quickViewModal" data-id="{{$fishe->id}}" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> -->
											<!-- /quick-view --> 
										</div>
										<!-- /product image --> 
										<!-- product name -->
										<div class="product__inside__name">
											<h2><a href="{{ action('FrontPageController@getProduct',$fishe->id) }}">{{ $fishe->name }}</a></h2>
										</div>
										<!-- /product name -->                 <!-- product description --> 
										<!-- visible only in row-view mode -->
										<div class="product__inside__description row-mode-visible"> {!! $fishe->short_description !!} </div>
										<!-- /product description -->                 <!-- product price -->
										<div class="product__inside__price price-box"> ৳ {{ $fishe->real_price }}</div>
										<!-- /product price --> 
										<!-- product review --> 
										<!-- visible only in row-view mode -->
										...
										<div class="product__inside__hover">
											...
											<div class="product__inside__info">
												<div class="product__inside__info__btns"> <a href="{{ action('CartController@addItem',$fishe->id) }}" class="btn btn--ys btn--xl self-add-to-cart"><span class="icon icon-shopping_basket"></span> Add to cart</a>
