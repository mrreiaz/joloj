			...
			<div class="container">
				...
				<div class="row">
					...
					<aside class="col-md-12 col-lg-12 col-xl-12" id="centerColumn">
						<!-- title -->
						<div class="title-box">
							<h2 class="text-center text-uppercase title-under">Aquarium Plant's</h2>
						</div>
						<!-- /title -->												
								...
								<div class="product product--zoom">
									<div class="product__inside">
										...
										<div class="product__inside__image">
											<a href=""> <img src="public/{{ $plant->product_photo }}" alt="{{ $plant->name }}"> </a> 
											<!-- quick-view --> 
										...
										<div class="product__inside__name">
											<h2><a href="">{{ $plant->name }}</a></h2>
										</div>
										<!-- /product name -->                 <!-- product description --> 
										<!-- visible only in row-view mode -->
										<div class="product__inside__description row-mode-visible">{!! $plant->short_description !!} </div>
										<!-- /product description -->                 <!-- product price -->
										<div class="product__inside__price price-box">৳ {{ $plant->real_price }}</div>
										<!-- /product price --> 
										<!-- product review --> 
										<!-- visible only in row-view mode -->
										...
										<div class="product__inside__hover">
											...
											<div class="product__inside__info">
												<div class="product__inside__info__btns"> <a href="{{ action('CartController@addItem',$plant->id) }}" class="btn btn--ys btn--xl"><span class="icon icon-shopping_basket"></span> Add to cart</a>
