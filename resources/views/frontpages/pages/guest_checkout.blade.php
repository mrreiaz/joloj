			...
			<div class="container">				
				...
				<div class="row">					
					<div class="col-sm-4 col-xs-12">
						<div class="pull-left">
							<a href="{{ action('FrontPageController@getUserSignIn') }}" class="btn btn--ys"><span class="icon icon-vpn_key"></span>Login</a>
						</div>
						<div class="pull-left" style="margin-left: 15px;">
							<a href="" class="btn btn--ys"><span class="icon icon-vpn_key"></span>Shopping As A Guest</a>
						</div>
					</div>
							...
							<div class="collapse-block no-border-bottom open">
								...
								<div class="collapse-block__content" style="display: block;">
									...
									<div class="input-group" style="width:100%;">									    
									    <input type="number" class="form-control" name="copon">
									</div>
								</div>
							</div>		
							<!-- /Discount Codes -->
