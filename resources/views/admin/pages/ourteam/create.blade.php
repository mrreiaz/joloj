                    ...
                    <div class="inner bg-container">
                        <div class="card">
                            <div class="card-block m-t-25">
                                ...
                                <form class="form-horizontal login_validator bv-form" id="tryitForm" action="{{ action('OurTeamController@store') }}" method="POST" enctype="multipart/form-data">
                                   {{ csrf_field() }}
                                        ...
                                        <div class="col-xl-12">
                                                ...
                                                <div class="col-xs-12 col-lg-6 text-xs-center text-lg-left">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new img-thumbnail text-xs-center">
                                                            <img src="/public/admin/img/admin.jpg" data-src="" alt="not found"></div>
                                            ...
                                            <div class="form-group row m-t-25">
                                                ...
                                                <div class="col-xs-12 col-xl-8 col-lg-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"> <i class="fa fa-user text-primary"></i></span>
                                                        <input type="text" value="{{ old('designations') }}" name="designations" id="u-name" class="form-control" data-bv-field="title">
                                                    </div>
                                                </div>
                                            </div>
