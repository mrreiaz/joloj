                    ...
                    <div class="inner bg-container">
                        <div class="card">
                            <div class="card-block m-t-25">
                                ...
                                <form class="form-horizontal login_validator bv-form" id="tryitForm" action="{{ action('SliderController@store') }}" method="POST" enctype="multipart/form-data">
                                   {{ csrf_field() }}
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="form-group row m-t-25">
                                                ...
                                                <div class="col-xs-12 col-xl-8 col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{ old('title1') }}" name="title1" id="u-name" class="form-control" data-bv-field="title">
                                                    </div>
                                            ...
                                            <div class="form-group row m-t-25">
                                                ...
                                                <div class="col-xs-12 col-xl-8 col-lg-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"> <i class="fa fa-user text-primary"></i></span>
                                                        <input type="text" value="{{ old('bigtitle') }}" name="bigtitle" id="u-name" class="form-control" data-bv-field="title">
                                                    </div>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="firstName" data-bv-result="NOT_VALIDATED" style="display: none;">Enter the title</small></div>
                                            </div>
                                            ...
                                            <div class="form-group row m-t-25">
                                                ...
                                                <div class="col-xs-12 col-xl-8 col-lg-8">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"> <i class="fa fa-user text-primary"></i></span>
                                                        <input type="text" value="{{ old('title2') }}" name="title2" id="u-name" class="form-control" data-bv-field="title">
                                                    </div>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="firstName" data-bv-result="NOT_VALIDATED" style="display: none;">Enter the title</small></div>
                                            </div>
