                            ...
                            <div class="col-xs-12 data_tables">
                                ...
                                <div class="card m-t-35">
                                    <div class="card-header bg-white">
                                        ...
                                        <a class="btn btn-info btn-lg pull-right" href="{{ action('SliderController@create') }}">Create Naw</a>
                                    </div>
                                                            ...
                                                            @if( count($slides)>0 )
                                                                @foreach($slides as $slide)
                                                                    <tr role="row" class="odd">
                                                                        <td class="sorting_1"> <strong> {{ $slide->title1 }} </strong> </td>
                                                                        <td> <img src="{{ $slide->slider_img }}" class="img-thumbnail" alt="Cinque Terre" width="100px" height="100px"> </td>
                                                                        <td> {{ $slide->created_at }} </td>
                                                                        <td> 
                                                                        
                                                                        <div class="row">
                                                                           <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xs-6 m-t-15">
                                                                               <a href="{{ action('SliderController@edit',$slide->id) }}" class="btn btn-info button-rectangle">Edit </a>
                                                                           </div>
                                                                           <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xs-6 m-t-15">
