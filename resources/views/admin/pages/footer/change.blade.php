                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-10 push-lg-1">
                                                                ...
                                                                <div class="input-group float">
                                                                    <textarea class="form-control" rows="10" name="footer_text">{{ $footer->footer_text }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row m-t-25">
                                                            <div class="col-lg-10 push-lg-1">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="google_plus" value="{{ $footer->google_plus }}">
                                                                </div>
                                                            </div>
                                                        </div>
