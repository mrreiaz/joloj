        ...
        <div class="inner bg-container">
            <div class="card">
                <div class="card-block m-t-25">
                   ...
                   {!! Form::open( ['method'=>'patch', 'class' =>'form-horizontal bv-form', 'id' => 'tryitForm', 'url'=> action('TestimonialController@update', $testimonial->id), 'enctype'=>'multipart/form-data' ]) !!}
                            ...
                            <div class="col-xl-12">
                                    ...
                                    <div class="col-xs-12 col-lg-6 text-xs-center text-lg-left">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new img-thumbnail text-xs-center">
                                                <img src="/public/{{ $testimonial->img }}" data-src="/public/{{ $testimonial->img }}" alt="not found"></div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="col-xs-12 col-xl-8 col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="{{ $testimonial->name }}" name="name" id="u-name" class="form-control" data-bv-field="title">
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="col-xs-12 col-xl-8 col-lg-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"> <i class="fa fa-user text-primary"></i></span>
                                            <input type="text" value="{{ $testimonial->name_title }}" name="name_title" id="u-name" class="form-control" data-bv-field="title">
                                        </div>
                                    <small class="help-block" data-bv-validator="notEmpty" data-bv-for="firstName" data-bv-result="NOT_VALIDATED" style="display: none;">Enter the title</small></div>
                                </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="col-xs-12 col-xl-8 col-lg-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"> <i class="fa fa-user text-primary"></i></span>
                                            <input type="text" value="{{ $testimonial->source }}" name="source" id="u-name" class="form-control" data-bv-field="title">
                                        </div>
                                    <small class="help-block" data-bv-validator="notEmpty" data-bv-for="firstName" data-bv-result="NOT_VALIDATED" style="display: none;">Enter the title</small></div>
                                </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <div class="col-xs-12 col-xl-8 col-lg-8">
                                        <div class="input-group">
                                            <textarea class="form-control" rows="15" name="body"> {{ $testimonial->body }} </textarea>
                                        </div>
                                         <small class="help-block" data-bv-validator="notEmpty" data-bv-for="firstName" data-bv-result="NOT_VALIDATED" style="display: none;">Enter the title</small></div>
                                </div>
