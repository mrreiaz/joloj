                    ...
                    <div class="main-bar row">
                        ...
                        <div class="col-lg-6 col-md-8 col-sm-8">
                            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ action('ProductController@create') }}">Add  Naw Product</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="col-xs-12 data_tables">
                                ...
                                <div class="card m-t-35">
                                    <div class="card-header bg-white">
                                        <i class="fa fa-table"></i> All Product`s
                                        <a class="btn btn-info btn-lg pull-right" href="{{ action('ProductController@create') }}">Add  Naw Product</a>
                                    </div>
                                            ...
                                            <div id="sample_6_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered table-hover  dataTable no-footer" id="sample_6" role="grid" aria-describedby="sample_6_info">
                                                        <thead>
                                                            <tr role="row">
                                                                <th rowspan="1" colspan="1" style="width: 100px;">Name</th>
                                                                <th rowspan="1" colspan="1" style="width: 80px;">Category</th>
                                                                <th tabindex="0" rowspan="1" colspan="1" style="width: 100px;">Image</th>
                                                            ...
                                                            @if( count($products)>0)
                                                                @foreach($products as $product)
                                                                    <tr role="row" class="odd">
                                                                        <td class="sorting_1"> <strong> {{ $product->name }} </strong> </td>
                                                    						
                                                                        <td class="sorting_1"> 
                                                                            @foreach($product->categories as $categorie ) 	
                                                                            <strong class="text-capitalize btn btn-info button-rectangle">{{ $categorie->name }} </strong> <br> <br>
                                                                            @endforeach
                                                                        </td>
                                                                        
                                                                        <td> <img src="/public/{{ $product->product_photo }}" class="img-thumbnail" alt="Cinque Terre" width="100px" height="100px"> </td>
                                                                        <td> {{ $product->created_at }} </td>
                                                                        <td> 
                                                                        
                                                                        <div class="row">
                                                                           <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xs-6 m-t-15">
                                                                               <a href="{{ action('ProductController@edit',$product->id) }}" class="btn btn-info button-rectangle">Edit </a>
                                                                           </div>
                                                                           <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xs-6 m-t-15">
