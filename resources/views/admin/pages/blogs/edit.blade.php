                    ...
                    <div class="inner bg-container">
                        <div class="card">
                            <div class="card-block m-t-25">
                               ...
                               {!! Form::open( ['method'=>'patch', 'class' =>'form-horizontal bv-form', 'id' => 'tryitForm', 'url'=> action('BlogController@update', $blog->id), 'enctype'=>'multipart/form-data' ]) !!}
                                        ...
                                        <div class="col-xl-12">
                                                ...
                                                <div class="col-xs-12 col-lg-6 text-xs-center text-lg-left">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new img-thumbnail text-xs-center">
                                                            <img src="/public/{{  $blog->blog_img }}" data-src="/public/{{  $blog->blog_img }}" alt="not found"></div>
                                            ...
                                            <div class="form-group row m-t-25">
                                                ...
                                                <div class="col-xs-12 col-xl-8 col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" value="{{  $blog->title }}" name="title" id="u-name" class="form-control" data-bv-field="title">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-xs-12 col-lg-9 push-lg-3">
                                                    <button class="btn btn-primary btn-lg" id="submit2" type="submit"> Save </button>
